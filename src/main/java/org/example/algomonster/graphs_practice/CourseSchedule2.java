...
public class CourseSchedule2 {
    /**
     * The problems asks us to find the ordering of courses to take. We know this involves the dependency of courses,
     * so we will find the topological ordering of these courses.
     *
     * We will build a graph with directed edges from a course's prereq to course itself, then find the topological
