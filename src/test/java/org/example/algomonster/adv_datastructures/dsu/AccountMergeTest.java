 ...
 */
public class AccountMergeTest extends TestCase {
    ...
    public void testExampleFromPrompt() {
        ...
        List<List<String>> out = AccountMerge.mergeAccounts(accounts);
    ...
    public void testSingleAccountAndEmptyInput() {
        ...
        assertAccountsEqualIgnoringOrder(single, AccountMerge.mergeAccounts(single));

        List<List<String>> empty = Collections.emptyList();
        assertAccountsEqualIgnoringOrder(empty, AccountMerge.mergeAccounts(empty));
    }
